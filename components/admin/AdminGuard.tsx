        ...
        <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-white/10 bg-[#0a0a0f]/75 px-5 backdrop-blur-md light:border-violet-500/15 light:bg-[#f4f4fb]/80">
          <div className="flex items-center gap-3">
            <button
              ...
              className="rounded-lg border border-white/10 p-2 text-slate-400 hover:bg-white/[0.05] hover:text-slate-100 lg:hidden light:border-violet-500/15 light:text-slate-600 light:hover:bg-white/75"
